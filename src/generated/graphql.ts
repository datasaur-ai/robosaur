...
export type Scalars = {
  ...
  /**
   * interface CustomExportScriptExecutableResult {
   *   document: ExportedDocument!
   * }
   */
  CustomExportScriptExecutableResult: any;
...
export type Cell = {
  ...
  conflicts?: Maybe<Array<Maybe<CellConflict>>>;
...
export type CreateTextDocumentInput = {
  ...
  customScriptId?: InputMaybe<Scalars['ID']>;
...
export type CustomImportScriptExecutableResult = {
  __typename?: 'CustomImportScriptExecutableResult';
  document: ImportedDocument;
  labelSets: Array<ImportedLabelSet>;
};
...
export enum CustomScriptLanguage {
  Typescript = 'TYPESCRIPT'
}

export enum CustomScriptPurpose {
  Export = 'EXPORT',
  Import = 'IMPORT'
}
...
export type DictionaryResultEntry = {
  ...
  definitions: Array<Maybe<DefinitionEntry>>;
...
export type ExportTextProjectDocumentInput = {
  /** Optional. The custom script to be used during the export process. Only applicable when `format` is `CUSTOM`. Defaults to `null`. */
  customScriptId?: InputMaybe<Scalars['ID']>;
   ...
   * Use `CUSTOM` to export using your team's custom export script, specified in `customScriptId`.
   */
...
export type Mutation = {
  ...
  createCustomScript: CustomScript;
  ...
  removeCustomScript: CustomScript;
  ...
  updateCustomScript: CustomScript;
  updateDataset: Dataset;
  updateDocumentBoundLabels: Array<DocumentBoundLabel>;
...
export type MutationRemoveCustomScriptArgs = {
  customScriptId: Scalars['ID'];
};
...
export type MutationUpdateCustomScriptArgs = {
...
export type MutationUpdateDocumentBoundLabelsArgs = {
  documentId: Scalars['ID'];
  labels: Array<DocumentBoundLabelInput>;
};
...
export type Query = {
  ...
  executeCustomExportScript: Scalars['CustomExportScriptExecutableResult'];
  executeCustomImportScript: CustomImportScriptExecutableResult;
  ...
  getCustomScript: CustomScript;
  getCustomScripts: Array<CustomScript>;
  ...
  getDocumentLabels: Array<DocumentBoundLabel>;
...
export type QueryExecuteCustomExportScriptArgs = {
  customScriptId: Scalars['ID'];
  documentId: Scalars['ID'];
};


export type QueryExecuteCustomImportScriptArgs = {
  content: Scalars['String'];
  customScriptId: Scalars['ID'];
};
...
export type QueryGetCustomScriptArgs = {
  customScriptId: Scalars['ID'];
};


export type QueryGetCustomScriptsArgs = {
  purpose?: InputMaybe<CustomScriptPurpose>;
  teamId: Scalars['ID'];
};
...
export type QueryGetDocumentLabelsArgs = {
  documentId: Scalars['String'];
};
...
export type SettingsInput = {
  /** Optional */
  documentMeta?: InputMaybe<Array<InputMaybe<DocumentMetaInput>>>;
  /** Required */
...
export type TextDocumentSettingsInput = {
  ...
  /** Optional. Sets the custom script to be used in the project. Defaults to `null`.  */
  customScriptId?: InputMaybe<Scalars['ID']>;
...
export type TextSentenceInput = {
  ...
  nerLabels?: InputMaybe<Array<InputMaybe<TextLabelInput>>>;
  posLabels?: InputMaybe<Array<InputMaybe<TextLabelInput>>>;
...
export type UpdateCustomScriptInput = {
  ...
  customScriptId: Scalars['ID'];
  language?: InputMaybe<CustomScriptLanguage>;
  name?: InputMaybe<Scalars['String']>;
};
...
export type UpdateTextDocumentInput = {
  chunks?: InputMaybe<Array<InputMaybe<TextChunkInput>>>;
