...
export type Scalars = {
  ...
  Float: number;
  /**
   * Answer is in the form of a JSON object.
...
export type Mutation = {
  ...
  /**
   * Deprecated. Please use `updateDocumentAnswers`.
   * @deprecated Deprecated. Please use `updateDocumentAnswers`.
   */
...
export type Query = {
  ...
  /**
   * Deprecated. Please use `getDocumentAnswers`.
   * @deprecated Deprecated. Please use `getDocumentAnswers`.
   */
