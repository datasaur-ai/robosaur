export enum ExtensionID {
  AUTO_LABEL_SPACY_EXTENSION_ID = 'AUTO_LABEL_SPACY_EXTENSION_ID',
  AUTO_LABEL_DOC_EXTENSION_ID = 'AUTO_LABEL_DOC_EXTENSION_ID',
...
export const EXTENSIONS = {
  ...
  DOCUMENT_BASED: {
    LABELER: [ExtensionID.DOCUMENT_LABELING_EXTENSION_ID, ExtensionID.FILE_COLLECTION_EXTENSION_ID],
    REVIEWER: [
      ExtensionID.REVIEW_EXTENSION_ID,
      ExtensionID.DOCUMENT_LABELING_EXTENSION_ID,
      ExtensionID.FILE_COLLECTION_EXTENSION_ID,
